        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <div class="d-flex align-items-center mb-5 gap-3">
                    ...
                    <div>
                        <h2 class="text-white m-0" style="text-shadow: 0 0 20px rgba(16, 185, 129, 0.3);">Edit Note</h2>
                        <p class="text-secondary m-0">Refine your thoughts</p>
                    </div>
                </div>
                    ...
                    <form action="{{ route('notes.update', $note->id) }}" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <textarea
                                ...
                                rows="8">{{ old('content', $note->content) }}</textarea>
                                @error('content')
                                    <span class="invalid-feedback ps-1 mt-2">{{ $message }}</span> 
                                @enderror
                        </div>
